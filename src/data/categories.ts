...
export const australianCities = [
  { name: "سیدنی (NSW)", slug: "sydney" },
  { name: "ملبورن (VIC)", slug: "melbourne" },
  { name: "بریزبن (QLD)", slug: "brisbane" },
  { name: "پرث (WA)", slug: "perth" },
  { name: "آدلاید (SA)", slug: "adelaide" },
  { name: "کانبرا (ACT)", slug: "canberra" },
  { name: "هوبارت (TAS)", slug: "hobart" },
  { name: "داروین (NT)", slug: "darwin" },
  { name: "گلد کوست (QLD)", slug: "gold-coast" },
  { name: "نیوکاسل (NSW)", slug: "newcastle" },
  { name: "ولونگونگ (NSW)", slug: "wollongong" },
  { name: "جیلانگ (VIC)", slug: "geelong" },
  { name: "تاونزویل (QLD)", slug: "townsville" },
  { name: "کرنز (QLD)", slug: "cairns" },
];
