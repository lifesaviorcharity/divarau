              ...
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  {[
                    ...
                    <label key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                      <div>
                      ...
                      <div className="relative">
                        <input type="checkbox" checked={item.checked} onChange={(e) => item.onChange(e.target.checked)}
                          className="sr-only" />
                        <div className={`w-10 h-5 rounded-full transition-colors ${item.checked ? "bg-primary" : "bg-gray-300"}`}>
                          <div className={`w-4 h-4 rounded-full bg-white shadow-sm transition-transform mt-0.5 ${item.checked ? "mr-0.5" : "mr-[22px]"}`} />
                        </div>
                      </div>
                    </label>
                  ))}
            ...
            {activeSection === "rules" && (
              <div className="space-y-5">
                ...
                <div className="bg-teal-50 border border-teal-200 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-semibold text-gray-700 mb-1">حداکثر آگهی رایگان (در ماه)</label>
