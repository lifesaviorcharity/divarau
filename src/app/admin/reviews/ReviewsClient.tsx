        ...
        <div className="bg-red-50 border border-red-100 rounded-2xl p-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 items-stretch sm:items-center">
            ...
            <button
              ...
              className="px-5 py-2 bg-red-500 text-white text-sm font-bold rounded-xl hover:bg-red-600 transition-colors shrink-0 flex items-center justify-center gap-1"
            >
              <Trash2 size={16} />
              حذف گروهی
            </button>
