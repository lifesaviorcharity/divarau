...
import { ChevronLeft, AlertTriangle, Trash2, CreditCard } from "lucide-react";
import { useSession } from "next-auth/react";

export default function CommercialAdPage() {
  ...
  // Exclude vehicles and home-kitchen from commercial (they are free)
    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="max-w-xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 mb-6">
          ...
          <ChevronLeft size={12} />
          <span className="text-gray-700">ثبت آگهی تجاری</span>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <h2 className="text-xl font-black text-primary text-center mb-6">ثبت آگهی تجاری</h2>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-center gap-3">
              ...
              <p className="text-sm text-amber-800">
                این آگهی به‌صورت تجاری ثبت می‌شود. پس از تأیید، به صفحه پرداخت هدایت خواهید شد.
              </p>
            </div>
